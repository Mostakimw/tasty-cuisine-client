...
const Blog = () => {
  return (
    <div className="w-8/12 mx-auto mt-12 lg:mt-24">
      ...
      <div>
        ...
        <div className="mt-8">
          ...
          <p className="mtext-secondary">
            ...
            state internally. Their value is not controlled by react. Instead it
            is controlled by DOM. It's value retrieve through a ref. <br />A
            controlled component refers to components that have their own state
            and behavior controlled by the parent component. Their value is
            control by react. We can use an onchange pror to update value.
          </p>
        </div>
        ...
        <div className="mt-8">
          ...
          <p className="mtext-secondary">
            ...
            ourselves. Hooks are reusable funtions. When we need to share logic
            or data between other Javascript function or Components we use hook.
            Custom hook starts with 'use'. Custom hooks can help simplify code,
            improve code organization, and reduce repetition and the time to
            write code. It also enhances the rendering speed if the code as a
            custom hook doesn't need to be rendered again and again. And we can
            use anywhere in our component where we need to use.
          </p>
        </div>
        <div className="mt-8">
          <h2 className="mb-5 text-3xl text-gray-900 my-font">
          ...
          <p className="mtext-secondary">
            Node.js is an open source server environment, cross-platform runtime
            environment That allows to developers to build server side
            ...
            web applications, including middleware for routing, handling request
            and responses. It's highly extensible and easier to build web
            applications.
          </p>
        </div>
      </div>
