...
const Info = () => {
  return (
    <div className="max-w-[1300px] mx-auto mt-12 px-3 lg:mt-20">
      ...
      <div className="lg:grid grid-cols-12 gap-8 mt-4 px-3">
        <div className="col-span-4">
          <h2 className="mb-8 text-3xl text-gray-900 my-font">Events</h2>
        ...
        <div className="col-span-4">
          <h2 className="mb-8 max-sm:mt-8 text-3xl text-gray-900 my-font">
            Opening Hours
          </h2>
